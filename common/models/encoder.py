...
class MultimodalObsEncoder:
    ...
    def __init__(self, expert_dist, h_size: int, s_size: int, activation: nn.Module, embedding_sizes: Dict, hidden_size: int, min_std_dev: float, device, use_prior_expert=False):
