...
def calc_params_of_pca(image, dt=100):
    image = image[::dt]
    ...
    lambd_eigen_value, p_eigen_vector = torch.linalg.eigh(cov, UPLO='U')
    return lambd_eigen_value, p_eigen_vector
...
# crop image data for set to replay buffer
